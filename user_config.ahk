...
#c::MoveCurrentWindowToDesktop(1)
#v::MoveCurrentWindowToDesktop(2)
#b::MoveCurrentWindowToDesktop(3)
#n::MoveCurrentWindowToDesktop(4)
#m::MoveCurrentWindowToDesktop(5)
#,::MoveCurrentWindowToDesktop(6)
;#m::MoveCurrentWindowToDesktop(7)
